...
class UpdateTask extends StatefulWidget {
  ...
  @override
  State createState() => _UpdateTaskState();
}
...
class _UpdateTaskState extends State<UpdateTask> {
  ...
  late DateTime selectedDatedead;
  ...
  void initState() {
    ...
    _textEditingController = TextEditingController(
        text: DateFormat.yMMMd().format(
            DateTime.parse(widget.task['Schedule Date'].toDate().toString())));
    _textEditingController1 = TextEditingController(
        text: DateFormat.yMMMd().format(
            DateTime.parse(widget.task['Deadline Date'].toDate().toString())));
    _timeController = TextEditingController(text: widget.task['Schedule Time']);
    _timeController1 =
        TextEditingController(text: widget.task['Deadline Time']);
    selectedDate =
        DateTime.parse(widget.task['Schedule Date'].toDate().toString());
    selectedDatedead =
        DateTime.parse(widget.task['Deadline Date'].toDate().toString());
